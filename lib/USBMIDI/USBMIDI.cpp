...
// Define CFG_TUD_ENDOINT_SIZE if not already defined
/*
 next three lines were added by copilot to fix the build error, and it works :-)
 it seems "esp32-hal-tinyusb.h" can be ommited from the include list, but just
 leave it there for reference.
*/
#ifndef CFG_TUD_ENDOINT_SIZE
#define CFG_TUD_ENDOINT_SIZE 64  // Default endpoint size
#endif
